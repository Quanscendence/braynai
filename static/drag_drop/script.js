				...
				$(document).one('click','#view_row_constructor_'+clone.value, function (e) {
							...
							var html = `<div id="row-constructor-${clone.id}"  title="ROW CONSTRUCTOR" style="display:none;">
													...
													<div class="row" style="margin-left: 23px;" class="modal_box">
														<div class="col-md-6">
															<select class="change_columns_${clone.id} form-control" name="change_columns" onchange="displayColumns('change_columns_${clone.id}',${true})">
															...
															<div class="row two_columns">
																<div class="col-md-6 ">
																		<div class="two_target_options_1">
																...
																<div class="col-md-6 ">
																		<div class="two_target_options_2">
															...
															<div class="row three_columns">
																<div class="col-md-4 ">
																	<div class="three_target_options_1">
																...
																<div class="col-md-4">
																		<div class="three_target_options_2">
																...
																<div class="col-md-4">
																		<div class="three_target_options_3">
...
//START: FUNCTION TO OPENMODAL
function openRowModal(ele,id,dynamic_value) {
	// console.log(ele+" "+id);
	$("#"+id).dialog({
    modal: true,
    draggable: false,
    ...
    buttons: {
        "SAVE TEXT": function() {
						if($('.change_columns_'+dynamic_value).val()==="two_columns"){
								...
								row_constructor_object['row_'+id]['col_1'].block = $('.blocks_t1').val()
								row_constructor_object['row_'+id]['col_1'].image = $('.image_link_t1').val()
								row_constructor_object['row_'+id]['col_1'].text = $('.text_area_t1').val()
								// row_constructor_object['row_1']['col_1'].blank = $('.text_area_t1').val()


								row_constructor_object['row_'+id]['col_2'].block = $('.blocks_t2').val()
								row_constructor_object['row_'+id]['col_2'].image = $('.image_link_t2').val()
								row_constructor_object['row_'+id]['col_2'].text = $('.text_area_t2').val()
								...
								row_constructor_object['row_'+id]['col_1'].block = $('.blocks_th1').val()
								row_constructor_object['row_'+id]['col_1'].image = $('.image_link_th1').val()
								row_constructor_object['row_'+id]['col_1'].text = $('.text_area_th1').val()
								// row_constructor_object['row_1']['col_1'].blank = $('.text_area_t1').val()


								row_constructor_object['row_'+id]['col_2'].block = $('.blocks_th2').val()
								row_constructor_object['row_'+id]['col_2'].image = $('.image_link_th2').val()
								row_constructor_object['row_'+id]['col_2'].text = $('.text_area_th2').val()
									// row_constructor_object['row_1']['col_2'].blank = $('.text_area_t1').val()

								// console.log(row_constructor_object)
								// alert($('.blocks_th3').val())
								row_constructor_object['row_'+id]['col_3'].block = $('.blocks_th3').val()
								row_constructor_object['row_'+id]['col_3'].image = $('.image_link_th3').val()
								row_constructor_object['row_'+id]['col_3'].text = $('.text_area_th3').val()
									// row_constructor_object['row_1']['col_2'].blank = $('.text_area_t1').val()
...
function displayColumns(dynamic_value_option,status) {
	// alert(dynamic_value_option)
	console.log(status)
	var select_target_options = `
		<select class="selected_target_values form-control" id="endpoint_options_id" name="gerg" onchange="DisplayFeatureOptions(this)">
			<option value=""></option>
	...
	if($('.'+dynamic_value_option).val()==="two_columns"){
		...
		if(isShowTwoColumns) {
			$('.two_target_options_1').append(select_target_options)
			// $('#target_options_children').html(select_target_options)
			// $('.two_target_options_1').children().addClass('t1')
			$('.two_target_options_1').children().addClass('t1')
			$('.two_target_options_1').next().addClass('display_features_select_option_t1')


			$('.two_target_options_2').append(select_target_options)
			$('.two_target_options_2').children().addClass('t2')
			$('.two_target_options_2').next().addClass('display_features_select_option_t2')
		...
		if(isShowThreeColumns){
			$('.three_target_options_1').append(select_target_options)
			$('.three_target_options_1').children().addClass('th1')
			$('.three_target_options_1').next().addClass('display_features_select_option_th1')

			// $('.three_target_options_1').children().addClass('th1')

			$('.three_target_options_2').append(select_target_options)
			$('.three_target_options_2').children().addClass('th2')
			$('.three_target_options_2').next().addClass('display_features_select_option_th2')
			// $('.three_target_options_2').children().addClass('th2')

			$('.three_target_options_3').append(select_target_options)
			$('.three_target_options_3').children().addClass('th3')
			$('.three_target_options_3').next().addClass('display_features_select_option_th3')
			// $('.three_target_options_3').children().addClass('th3')
...
function DisplayFeatureOptions(ele,data) {
