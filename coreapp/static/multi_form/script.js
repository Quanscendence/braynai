...
//Function to disable Integrations

function disableFunction() {
    $('.disable_functionality').removeClass('disabled');
    $('.api_integration').addClass('disabled');

}

function removeDisable() {
    $('.api_integration').removeClass('disabled');
    $('.disable_functionality').addClass('disabled');
}
